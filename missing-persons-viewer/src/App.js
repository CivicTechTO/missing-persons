...
const missingList = Object.getOwnPropertyNames(missing_persons).map(function (e) { return missing_persons[e]; });
...
function App() {
  ...
  */
  ...
  function filteredRemains() {
    ...
    return currentMissing.MatchedUnidentified.map(personID => unidentified_remains[personID]);
  }
      ...
      <Stack spacing={3} className="main-grid">
        ...
        <Grid container spacing={2}>
          ...
          <Grid container xs={12} md={10}>
            <MissingPersonsSection person_list={missingList} onSearch={setCurrentMissing} />
